...
func request_EncounterCompletionService_StartEncounter_0(ctx context.Context, marshaler runtime.Marshaler, client EncounterCompletionServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq IdRequest
	var metadata runtime.ServerMetadata
...
func local_request_EncounterCompletionService_StartEncounter_0(ctx context.Context, marshaler runtime.Marshaler, server EncounterCompletionServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq IdRequest
	var metadata runtime.ServerMetadata
...
func RegisterEncounterCompletionServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server EncounterCompletionServiceServer) error {
	...
	mux.Handle("POST", pattern_EncounterCompletionService_StartEncounter_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/encounter.EncounterCompletionService/StartEncounter", runtime.WithHTTPPathPattern("/tourist/encounter/start/{Id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_EncounterCompletionService_StartEncounter_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_EncounterCompletionService_StartEncounter_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterEncounterCompletionServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client EncounterCompletionServiceClient) error {
	...
	mux.Handle("POST", pattern_EncounterCompletionService_StartEncounter_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/encounter.EncounterCompletionService/StartEncounter", runtime.WithHTTPPathPattern("/tourist/encounter/start/{Id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_EncounterCompletionService_StartEncounter_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_EncounterCompletionService_StartEncounter_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"tourist", "encounter", "start", "Id"}, ""))
...
var (
	...
	forward_EncounterCompletionService_StartEncounter_0 = runtime.ForwardResponseMessage
